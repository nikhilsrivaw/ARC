    ...
    static async register(data: {
        ...
        try {
            ...
            await database.query(
                'public',
                `INSERT INTO accounts (id , email , password_hash , status , email_verified , created_at)
                VALUES ($1 , $2 , $3 , $4 , $5 , $6)`,
            ...
            await database.query(
                'public',
                `INSERT INTO workspace (id , name , owner_id , slug , subscription_tier , status , created_at)
